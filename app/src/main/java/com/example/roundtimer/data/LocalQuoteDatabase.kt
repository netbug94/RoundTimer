...
object LocalQuotesDatabase {
    private val quotes: List<Quote> = listOf(
        ...
        Quote(19, "To see a man beaten not by a better oponent, but by himself is a tragedy.", "Cu D'Amato"),
        Quote(20, "Software is like sex, it’s better when it’s free", "Linus Torvalds"),
