package com.netbug94.roundtimer.quote.data
...
object LocalQuotesDataBase : QuotesDataSource {
    private val quotes: List<Quote> = listOf(
        Quote(
            1,
            "You can never understand a person unless you can understand what makes them angry.",
            "One Punch Man"
        ),
        ...
        Quote(
            8,
            "Every body on mount Everest was once a very determined individual; maybe calm down.",
            ""
        ),
        ...
        Quote(
            16,
            "Knowing what you're supposed to do is easy. Doing what you're supposed to do is one of the hardest things in life.",
            ""
        ),
        Quote(
            17,
        ...
        Quote(
            18,
            "The way you need love is the way you lacked love, and the way you give love is the way you were given love.",
            ""
        ),
        Quote(
            19,
        ...
        Quote(
            40,
            "The worst danger that a man faces is not the danger of his enemies, but the indifference of his friends.",
            "Bertolt Brecht"
        ),
        Quote(
            41,
        ...
        Quote(
            44,
            "The most important thing is to be in your experience, not to be stuck in your mind.",
            "Sadhguru"
        ),
        Quote(
            45,
