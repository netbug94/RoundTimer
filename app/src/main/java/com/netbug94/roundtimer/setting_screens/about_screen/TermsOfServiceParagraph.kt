...
fun TermsOfServiceParagraph(
    ...
    val termsOfServiceParagraphTitle = stringResource(R.string.TermsOfServiceParagraphTitleString)
    val termsOfServiceParagraph = stringResource(R.string.TermsOfServiceParagraphString)
