...
fun AboutScreen(
    ...
    val versionText = stringResource(R.string.VersionString)
    ...
    val descriptionString = stringResource(R.string.DescriptionString)
    val privacyPolicyString = stringResource(R.string.PrivacyPolicyString)
    val termsOfServiceString = stringResource(R.string.TermsOfServiceString)
    val sendFeedback = stringResource(R.string.SendFeedbackString)
